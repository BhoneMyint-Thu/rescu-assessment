  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        // Read reactive data here, before the lazy item builder runs.
        ...
        return SmartRefresher(
          ...
          child: ListView.builder(
            ...
            itemCount: deals.length + 2, // Header and bottom spacing.
      ...
      floatingActionButton: Obx(() => controller.showScrollToTopButton.value
